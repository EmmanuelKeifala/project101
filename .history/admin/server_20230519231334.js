		...
		try {
			...
			try {
				await sendMail({
					...
					message: `Hello ${oldApplication.name}, We are very happy to inform you that your application for a birth certificate have been vetted and it has been accepted`,
				});
				res.status(201).json({
					success: true,
