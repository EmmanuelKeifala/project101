...
const styles = {
	...
	active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#146C94]",
	button:
		"w-[150px] bg-[#146C94] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer",
	cart_button:
	...
	input: "w-full border p-4 rounded-[5px]",
	activeStatus:
